...
def drawHighScore(high_score):
    high_score_msg = score_font.render("High Score : ", 1, pygame.Color("green"))
    high_score_numb = score_numb_font.render(str(high_score), 1, pygame.Color("red"))
    screen.blit(high_score_msg, (SCREEN_WIDTH - score_msg_size[0] - 130, 50))
    screen.blit(high_score_numb, (SCREEN_WIDTH - 45, 54))
...
def main():
    ...
    mySnake.move()
    start_segments = 3  # Initially we will have a 3-segment long snake
    ...
    eaten_apple = False  # As snake eats food apple will disappear
